        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="{{ route('posts.index') }}" class="flex-shrink-0 flex items-center">
                    <p class="text-white text-bold text-2xl">SignalsTalk</p>
                </a>
                <!-- MENU LG -->
...
{{--                        <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>--}}
            ...
            @else
                <div>
                    <a href="{{ route('login') }}"
                       class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{!! __('Login') !!}</a>
